...
abstract class AdminOverview
  ...
  factory AdminOverview.fromJson(Map<String, dynamic> jsonSerialization) {
    return AdminOverview(
      ...
      fetchInterval: _isc.DurationJsonExtension.fromJson(
        jsonSerialization['fetchInterval'],
      ),
      removeOldDataAfter: _isc.DurationJsonExtension.fromJson(
        jsonSerialization['removeOldDataAfter'],
      ),
      sources: _ix1idbfg.Protocol()
      ...
      lastWeek: _ix1idbfg.Protocol().deserialize<_ipqd24x9.VoteStats>(
        jsonSerialization['lastWeek'],
      ),
      lastMonth: _ix1idbfg.Protocol().deserialize<_ipqd24x9.VoteStats>(
        jsonSerialization['lastMonth'],
      ),
      dailyStats: _ix1idbfg.Protocol().deserialize<List<_ibr24dhf.DailyStats>>(
