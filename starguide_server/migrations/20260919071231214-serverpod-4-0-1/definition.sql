...
--
-- Class ChatSession as table chat_session
--
...
-- Indexes
CREATE INDEX "createdAt" ON "chat_session" USING btree ("createdAt");

--
-- Class DailyStats as table daily_stats
--
...
--
-- Class RAGDocument as table rag_document
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('starguide', '20260919071231214-serverpod-4-0-1', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260919071231214-serverpod-4-0-1', "timestamp" = now();
